...
#+BEGIN_SRC emacs-lisp
  ...
  ;; remap TAB key if running in terminal mode
  (if (display-graphic-p)
      (message "running in graphic UI")
...
#+BEGIN_SRC emacs-lisp
    ...
    ;; I am no longer opening .txt files in org mode.
    ;; (add-to-list 'auto-mode-alist '("\\.\\(org_archive\\|txt\\)$" . org-mode))

    ;; However, we will temporarily open txt files ;; in org format in org-mode
  ;;   (defun my/txt-file-maybe-org ()
  ...
  ;;         (org-mode)
  ;;         (message "This .txt file looks like an Org file; consider renaming it to .org: %s"
  ;;                  (file-name-nondirectory buffer-file-name))))))

  ;; (add-hook 'find-file-hook #'my/txt-file-maybe-org)
...
* Misc tweaks
From [[https://emacsredux.com/blog/2026/04/07/stealing-from-the-best-emacs-configs/][Bozhidar Batsov]].

#+begin_src emacs-lisp
  ;; Disable right-to-left language support, which speeds buffer drawing
  ...
  ;; leave cursor in help-buffer
  (setq help-window-select t)

  (setq save-place-mode t)

  ;; Have C-x 1 toggle between single window and restoring previous window layout.
  (winner-mode +1)
...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    (setq evil-want-C-u-scroll t) ;; Make C-u work like in vim (page up)
    (setq evil-undo-system 'undo-redo)
    
    :config
    (evil-mode 1)
    
    ;; Make movement keys respect visual lines
    ...
    ;; Emacs application/interface modes: use native bindings.
  ...
  ;; I have abandoned evil-collection and have deleted the package
